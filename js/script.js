...
$(window).bind("load", function(){
    ...
    if(url == "https://tentucare.com/"){
        ...
        document.title="民間救急搬送テンツーケア";
        $(function(){
            $("meta[name ='description']").attr('content','テンツーケアは24時間ご対応可能な民間救急搬送（介護タクシー）サービスです。武蔵野市を中心に都内全域、関東・関西など、日本全国どこへでも搬送が可能です。');
...
$(window).bind("load", function(){
    ...
    if(document.URL.match("/instrument.html")) {
        ...
        document.title="民間救急搬送テンツーケア 搬送器具について";
        $(function(){
    ...
    if(document.URL.match("/process.html")) {
        ...
        document.title="民間救急搬送テンツーケア 搬送の流れについて";
        $(function(){
            $("meta[name ='description']").attr('content','テンツーケアの「搬送の流れ」について記載してあります。初めて介護タクシーをご利用さるる方や、テンツーケアでのご予約の流れなどもご確認いただけます。');
    ...
    if(document.URL.match("/information.html")) {
        ...
        document.title="民間救急搬送テンツーケア お知らせについて";
        $(function(){
